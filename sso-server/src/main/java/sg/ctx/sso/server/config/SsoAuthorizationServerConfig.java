...
import sg.ctx.sso.server.service.UserDetailService;
...
public class SsoAuthorizationServerConfig  extends AuthorizationServerConfigurerAdapter {
    ...
    public void configure(ClientDetailsServiceConfigurer clients) throws Exception {
        clients.inMemory()
                ...
                .scopes("all")
                .autoApprove(true)
                .redirectUris("http://127.0.0.1:9090/app1/login","http://localhost:9090/app1/login")
                .and()
                .withClient("app-b")
                ...
                .scopes("all")
                .autoApprove(true)
                .redirectUris("http://127.0.0.1:9091/app2/login","http://localhost:9091/app2/login")
                .and()
                .withClient("app-c")
